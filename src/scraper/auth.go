...
func (s *Scraper) IsLoggedIn() bool {
	s.isLogged = true
	s.setBearerToken(randomGuestBearerToken2)
	...
	if err != nil || verify.Errors != nil {
		s.isLogged = false
		s.setBearerToken(randomGuestBearerToken)
	} else {
		s.isLogged = true
	}
	return s.isLogged
